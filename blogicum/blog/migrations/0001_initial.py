# Generated by Django 4.2.24 on 2025-09-28 19:43
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('pub_date', models.DateTimeField(help_text='Если дата в будущем — публикация будет отложенной.', verbose_name='Дата и время публикации')),
                ('image', models.ImageField(blank=True, null=True, upload_to='posts_images/', verbose_name='Картинка')),
